...
import {Universities, Course} from'./../modals/constant';
//import DataContext
import SelectComponent from './../projectHook/selecthookcomponent';
import TableHookComponent from './../projectHook/tablehookcomponent';

const StudentHookComponent=() => {
    // defining state for Student, Students
    const [student, updateStudent] = useState({StudentId:0, StudentName:'', University:'', Course:'', Fees:0});
    ...
    const clear=() => {
        updateStudent({StudentId:0, StudentName:'', University:'', Course:'', Fees:0});
    }
    ...
    return (
        <div className="container">
            ...
            <div className="form-group">
                <label>Course</label>
                <SelectComponent data={Course} emitValue={setCourseValue}></SelectComponent>
            </div>
            <div className="form-group">
                <label>Fees</label>
